class CropperDecorator {
  ...
  clear(cropperComponentId) {
    return this.cropperInstances[cropperComponentId].clear();
  }

  crop(cropperComponentId) {
    return this.cropperInstances[cropperComponentId].crop();
  }

  destroy(cropperComponentId) {
    this.cropperInstances[cropperComponentId].destroy();
    delete this.cropperInstances[cropperComponentId];
  }

  disable(cropperComponentId) {
    return this.cropperInstances[cropperComponentId].disable();
  }

  enable(cropperComponentId) {
    return this.cropperInstances[cropperComponentId].enable();
  }

  getCanvasData(cropperComponentId) {
    return this.cropperInstances[cropperComponentId].getCanvasData();
  }

  getContainerData(cropperComponentId) {
    return this.cropperInstances[cropperComponentId].getContainerData();
  }

  getCropBoxData(cropperComponentId) {
    return this.cropperInstances[cropperComponentId].getCropBoxData();
  }
  ...
  getCroppedCanvas(cropperComponentId, options) {
    ...
    return this.cropperInstances[cropperComponentId].getCroppedCanvas(options);
  }
  ...
  getData(cropperComponentId, rounded) {
    return this.cropperInstances[cropperComponentId].getData(rounded);
  }

  getImageData(cropperComponentId) {
    return this.cropperInstances[cropperComponentId].getImageData();
  }

  move(cropperComponentId, offsetX, offsetY) {
    return this.cropperInstances[cropperComponentId].move(offsetX, offsetY);
  }

  moveTo(cropperComponentId, x, y) {
    return this.cropperInstances[cropperComponentId].moveTo(x, y);
  }
  ...
  reset(cropperComponentId) {
    return this.cropperInstances[cropperComponentId].reset();
  }

  rotate(cropperComponentId, degree) {
    return this.cropperInstances[cropperComponentId].rotate(degree);
  }

  rotateTo(cropperComponentId, degree) {
    return this.cropperInstances[cropperComponentId].rotateTo(degree);
  }

  scale(cropperComponentId, scaleX, scaleY) {
    return this.cropperInstances[cropperComponentId].scale(scaleX, scaleY);
  }

  scaleX(cropperComponentId, scaleX) {
    return this.cropperInstances[cropperComponentId].scaleX(scaleX);
  }

  scaleY(cropperComponentId, scaleY) {
    return this.cropperInstances[cropperComponentId].scaleY(scaleY);
  }
  ...
  setCanvasData(cropperComponentId, data) {
    return this.cropperInstances[cropperComponentId].setCanvasData(data);
  }

  setCropBoxData(cropperComponentId, data) {
    return this.cropperInstances[cropperComponentId].setCropBoxData(data);
  }

  setData(cropperComponentId, data) {
    return this.cropperInstances[cropperComponentId].setData(data);
  }

  setDragMode(cropperComponentId, dragMode) {
    return this.cropperInstances[cropperComponentId].setDragMode(dragMode);
  }

  zoom(cropperComponentId, ratio) {
    return this.cropperInstances[cropperComponentId].zoom(ratio);
  }

  zoomTo(cropperComponentId, ratio, pivotX, pivotY) {
    return this.cropperInstances[cropperComponentId].zoomTo(ratio, {
      pivotX,
      pivotY,
    });
  }
  ...
  getJSEventDataDetail(instance) {
    if (instance.type === "zoom") {
      ...
      instance.type === "cropstart" ||
      instance.type === "cropend" ||
      instance.type === "cropmove"
    ) {
      return {
